 ...
 * Valve
 ...
 - Experiment: Tap **Run My Code** to see the internals of a working combustion engine! When you're done reading go to the [next page](@next)!
 ...
 * Exhaust: when the piston pushes out the burned gases.
 ...
 Those four processes are what generates power to move the car... but wait! Have you seen that little smoke!? That smoke comes from the burned gases and contains some substances that contribute on the air pollution, such as Nitrogen Oxides (NOx) and Carbon Monoxide (CO)! That is why, even though it's the most popular model, combustion engine cars are a problem to the environment!
*/
